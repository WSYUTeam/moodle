...
//echo $CFG->libdir . '/formslib_api.php';
...
abstract class mod_quiz_attempts_report_form extends moodleform {
    ...
    protected function definition() {
       ...
       // $this->other_attempt_fields($mform);
        ...
        $this->idnumber_preference_fields($mform);
    ...
    //学号
    protected function idnumber_preference_fields(MoodleQuickForm $mform) {
        $mform->addElement('text', 'idnumber', '学号');
        //$mform->setType('pagesize', PARAM_INT);
    }
