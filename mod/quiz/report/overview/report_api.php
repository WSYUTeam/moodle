...
require_once($CFG->dirroot . '/mod/quiz/report/attemptsreport_api.php');
require_once($CFG->dirroot . '/mod/quiz/report/overview/overview_options_api.php');
require_once($CFG->dirroot . '/mod/quiz/report/overview/overview_form_api.php');
require_once($CFG->dirroot . '/mod/quiz/report/overview/overview_table_api.php');
...
class quiz_overview_report extends quiz_attempts_report {
    ...
    public function display($quiz, $cm, $course) {
        ...
        // echo "<pre>";
        // print_r($this->form->MoodleQuickForm);
        // echo "</pre>";
