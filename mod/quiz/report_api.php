...
$url = new moodle_url('/mod/quiz/report_api.php', array('id' => $cm->id));
if ($mode !== '') {
    $url->param('mode', $mode);
}
$PAGE->set_url($url);
...
if (!is_readable("report/$mode/report_api.php")) {
    print_error('reportnotfound', 'quiz', '', $mode);
}

// Open the selected quiz report and display it.
$file = $CFG->dirroot . '/mod/quiz/report/' . $mode . '/report_api.php';
if (is_readable($file)) {
    include_once($file);
}
