...
/**
 * formslib_api.php - library of classes for creating forms in Moodle, based on PEAR QuickForms.
 *
...
MoodleQuickForm::registerRule('required', null, 'MoodleQuickForm_Rule_Required', "$CFG->libdir/formslib_api.php");
